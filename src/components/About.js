...
export default function About() {
  ...
  return (
    <div className="container" style={{ color }}>
      ...
      <p>
        <b>Textify</b> is a ReactJs website built primarily to do various
        operations on regular typed text. You can safely use WordPad or NotePad
        for text drafting, and saving, but <i>Textify</i> offers much more
        than simple text drafting and formatting. Textify can convert your
        ...
        reading time as well. The best part of <i>Textify</i> is that it is an
